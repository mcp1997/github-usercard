...
*/
axios.get('https://api.github.com/users/mcp1997')
  .then( res => {
    const githubData = cardCreator(res);
    cardDiv.appendChild(githubData);
  })
  .catch( err => {
